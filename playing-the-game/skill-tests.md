...
Uncontested tests are the most basic form of test.
...
It is vital that the story is never unchanged after a skill test, so when you fail an uncontested test, at least one of a few different things which will happen.
